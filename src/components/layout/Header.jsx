        ...
        <div className="container header__topbar-inner">
          ...
          <div className="header__topbar-right">
            ...
            <div className="header__topbar-socials">
              <a href="https://www.facebook.com/AlkhidmatPakistan/" target="_blank" rel="noopener noreferrer" aria-label="Facebook"><svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg></a>
              ...
              <a href="https://www.instagram.com/alkhidmatpakistan/" target="_blank" rel="noopener noreferrer" aria-label="Instagram"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg></a>
              <a href="https://www.youtube.com/@alkhidmatpakistan" target="_blank" rel="noopener noreferrer" aria-label="YouTube"><svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356 2.62-4.385 8.816.029 6.185.484 8.549 4.385 8.816 3.6.245 11.626.246 15.23 0 3.897-.266 4.356-2.62 4.385-8.816-.029-6.185-.484-8.549-4.385-8.816zM9 16V8l8 4-8 4z"/></svg></a>
            </div>
          </div>
        </div>
      </div>
      ...
      <nav className="header__nav" ref={dropdownRef}>
        <div className="container header__nav-inner">
          ...
          <div className="header__actions">
            <Link to="/ways-to-donate" className="btn btn-primary header__donate-btn">
              Donate Now
            </Link>
      ...
      <div className={`header__mobile ${mobileMenuOpen ? 'open' : ''}`}>
        <div className="header__mobile-inner">
          ...
          <div className="header__mobile-actions">
            <Link to="/ways-to-donate" className="btn btn-primary" style={{ width: '100%', justifyContent: 'center' }} onClick={() => setMobileMenuOpen(false)}>
              Donate Now
            </Link>
