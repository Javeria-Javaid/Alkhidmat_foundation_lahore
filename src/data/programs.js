...
export const programs = [
  ...
  { label: 'Community Services', href: '/programs/community-services', image: communityImg, description: 'Local welfare initiatives that strengthen families and neighborhoods.' },
  ...
  { label: 'Health', href: '/programs/healthcare', image: healthImg, description: 'Accessible healthcare and medical support for communities in need.' },
  ...
  { label: 'Mawakhat', href: '/programs/mawakhat', image: mawakhatImg, description: 'Interest-free financial support for families and small businesses.' },
];
